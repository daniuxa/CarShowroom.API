...
namespace CarShowroom.Dal.Migrations
{
    ...
    [Migration("20230215225432_AddInitDataAutomobileEntity")]
    partial class AddInitDataAutomobileEntity
    {
            ...
            modelBuilder.Entity("CarShowroom.Dal.Entities.Automobile", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EquipmentId = 1,
                            ModelId = 1,
                            ProdDate = new DateTime(2022, 2, 16, 0, 54, 30, 165, DateTimeKind.Local).AddTicks(8888)
                        });
                });
